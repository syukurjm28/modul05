...
document.querySelector('.btn-roll').addEventListener('click', function(){
   ...
   scores[activePlayer]=0;
			...
			nextPlayer();	
                console.log(dice+simpan);
            }
			hideRolledMsg();
             console.log(dice+' dan ' +simpan);
			simpan=dice;
			roundScore += dice;
...
function init() {
	...
	document.querySelector('#name-0').textContent = 'Pemain 1';
	document.querySelector('#name-1').textContent = 'Pemain 2';
